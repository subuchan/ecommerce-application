...
<main class="main" style="padding-top:70px;">
    ...
    <form action="<?=base_url('main/user_address_update/') . $address_edit[0]->id ?>" method="post">      
    <div class="contact-group">
        <h5>contact Details</h5>
    </div>        
      <div class="form-group">
        <!-- <label for="address" class="label-float">Address</label> -->
        <input name="name" class="form-control" value="<?=$address_edit[0]->user_name  ?>" type="text" placeholder="Name" >
      </div>

      <div class="form-group">
        <!-- <label for="route" class="label-float">Street</label> -->
        <input name="number" type="text" class="form-control" value="<?=$address_edit[0]->user_number  ?>"  placeholder="Contact Number" >
      </div>
      <div class="contact-group">
                   <h5>Address</h5>
                </div>  
      <div class="form-group">
        ...
        <input name="address" type="text" class="form-control"  value="<?=$address_edit[0]->user_address  ?>" placeholder="House No / Building Name" >
      </div>

      <div class="form-group">
        <!-- <label for="locality" class="label-float">City</label> -->
        <input name="pincode" type="text" class="form-control" value="<?=$address_edit[0]->user_pincode  ?>" placeholder ="Pincode" >
      </div>

      <div class="form-group">
        <!-- <label for="administrative_area_level_1" class="label-float">State</label> -->
        <input name="city" type="text" class="form-control" value="<?=$address_edit[0]->user_city  ?>"  placeholder="City" >
      </div>

      <div class="form-group">
        <!-- <label for="country" class="label-float">Country</label> -->
        <input name="state" type="text" class="form-control" value="<?=$address_edit[0]->user_state  ?>"  placeholder="State" >
      </div>

      <div class="form-group">
        <!-- <label for="postal_code" class="label-float">Zip code</label> -->
        <input name="nearby" type="text" class="form-control" value="<?=$address_edit[0]->user_nearby  ?>"  placeholder="Nearby Famous Place/Shop/School/,etc." >
      </div>
