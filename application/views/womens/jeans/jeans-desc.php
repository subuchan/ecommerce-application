                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="product-gallery">          
                                    ...
                                    <img id="product-zoom" src="<?= base_url('./upload/women/') . $data1[0]->product_img1 ?>"
                                        alt="product image">
                                ...
                                <div id="product-zoom-gallery" class="product-image-gallery product-gallery-masonry">
                                    <a class="product-gallery-item" href="#"
                                        data-image="<?= base_url('./upload/women/') . $data1[0]->product_img1 ?>"
                                        data-zoom-image="<?= base_url('./upload/women/') . $data1[0]->product_img1 ?>  ">
                                        <img src="<?= base_url('./upload/women/') . $data1[0]->product_img1 ?>"
                                            alt="product cross">
                                    </a>

                                    <a class="product-gallery-item gallery-item-wide" href="#"
                                        data-image="<?= base_url('./upload/women/') . $data1[0]->product_img2 ?>"
                                        data-zoom-image="<?= base_url('./upload/women/') . $data1[0]->product_img2 ?>">
                                        <img src="<?= base_url('./upload/men/') . $data1[0]->product_img2 ?>"
                                            alt="product with model">
                                    </a>

                                    <a class="product-gallery-item" href="#"
                                        data-image="<?= base_url('./upload/women/') . $data1[0]->product_img3 ?>"
                                        data-zoom-image="<?= base_url('./upload/women/') . $data1[0]->product_img3 ?>">
                                        <img src="<?= base_url('./upload/women/') . $data1[0]->product_img3 ?>"
                                            alt="product side">
                                    </a>
