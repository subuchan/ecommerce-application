                        ...
                        <div class="col-md-6">
                            ...
                            <div id="product-zoom-gallery" class="product-image-gallery product-gallery-masonry">
                                    <a class="product-gallery-item" href="#"
                                        data-image="<?= base_url('./upload/men/') . $row->product_img1 ?>"
                                        data-zoom-image="<?= base_url('./upload/men/') . $row->product_img1 ?>  ">
                                        <img src="<?= base_url('./upload/men/') . $row->product_img1 ?>"
                                            alt="product cross">
                                    </a>

                                    <a class="product-gallery-item gallery-item-wide" href="#"
                                        data-image="<?= base_url('./upload/men/') . $row->product_img2 ?>"
                                        data-zoom-image="<?= base_url('./upload/men/') .$row->product_img2 ?>">
                                        <img src="<?= base_url('./upload/men/') . $row->product_img2 ?>"
                                            alt="product with model">
                                    </a>

                                    <a class="product-gallery-item" href="#"
                                        data-image="<?= base_url('./upload/men/') . $row->product_img3 ?>"
                                        data-zoom-image="<?= base_url('./upload/men/') . $row->product_img3 ?>">
                                        <img src="<?= base_url('./upload/men/') . $row->product_img3 ?>"
                                            alt="product side">
                                    </a>
                                    ...
                                    <img id="product-zoom" src="<?= base_url('./upload/men/') . $row->product_img1 ?>"
                                        alt="product image">
                        ...
                        <div class="col-md-6">
                            <div class="product-details sticky-content">
                                ...
                                <div class="product-price">
                                    <span class="new-price"><?=$row->product_price?><i class="fa fa-inr pl-2" style="font-size:18px"></i></span>
                                ...
                                <!-- <h1><?= $row->productsize_m ?></h1>
                                <form action="<?= base_url('main/checkbox/') . $row->id  ?>" method="post">
                                ...
                                <div class="details-filter-row details-row-size">
                                   ...
                                   <h1 class="size_error"> <?php echo form_error('size'); ?> </h1>
                                    <form action="<?= base_url('main/add_cart/') . $row->id  ?>" method="post">
                                        <select name="size"  class="form-control"   id="select" class="form__select">
                                            <option value="">Select a size</option>
                                            <option value="<?= $row->product_size1 ?>"><?= $row->product_size1 ?></option>
                                            <option value="<?= $row->product_size2 ?>"><?= $row->product_size2 ?></option>
                                            <option value="<?= $row->product_size3 ?>"><?= $row->product_size3 ?></option>
                                            <option value="<?= $row->product_size4 ?>"><?= $row->product_size4 ?></option>
                                            <option value="<?= $row->product_size5 ?>"><?= $row->product_size5 ?></option>
                                            <option value="<?= $row->product_size6 ?>"><?= $row->product_size6 ?></option>
                                            <option value="<?= $row->product_size7 ?>"><?= $row->product_size7 ?></option>                  
                                        </select>
                                   ...
                                   <div class="product-details-action">
                                    ...
                                    <?php
                                       ...
                                       $userid=$user['id'];
                                         ...
                                         if( $success){
                                            ?>
                                             <a href="<?= base_url('main/cart_view_id/') . $userid  ?>" class="btn btn-info">GO TO CART</a>
                                            <?php
                                         }else{
                                            ?>
